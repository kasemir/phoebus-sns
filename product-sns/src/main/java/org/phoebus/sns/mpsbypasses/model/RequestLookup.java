...
public class RequestLookup
{
	...
	final private Map<String, Request> requests = new HashMap<>();
	 ...
	 */
	public RequestLookup(final JobMonitor monitor, final Connection connection) throws Exception
	{
		getRequests(monitor, connection);
	}

	private void getRequests(final JobMonitor monitor, final Connection connection) throws Exception
    {
